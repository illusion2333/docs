...
<img loading="lazy" src="../images/TransactionCache-txpool-internal-state.png"  alt="txpool status" style="zoom:70%;"/>
...
<img loading="lazy" src="../images/TransactionCache-chainmaker-txpool-flow.png"  alt="Raft共识与核心引擎交互图" style="width:900px;"/>
