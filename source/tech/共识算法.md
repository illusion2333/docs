...
流程图如下：
<br><img src="../images/Consensus-Raft-interaction-Core.png" alt="Raft共识与核心引擎交互图" style="zoom:60%;"/>
...
<br><img src="../images/Consensus-tbft-stage.png" alt="共识算法-tbft算法阶段图" style="width:800px;"/>

流程图如下：
<br><img src="../images/Consensus-tbft-flow.png" alt="共识算法-tbft流程图" style="zoom:70%;"/>
...
<img src="../images/Consensus-tbft-interaction-msgbus.png" alt="Raft共识与核心引擎交互图" style="zoom:80%;"/>
...
<img src="../images/Consensus-pipieline-hotstuff.png"  alt="hotstuff-投票处理" style="zoom:100%;"/>
...
1. HotstuffRoundTimeoutMill：共识view切换的基础超时时间
2. HotstuffRoundTimeoutIntervalMill：相同区块高度下，每次共识超时后增加的delta时间
...
<img src="../images/candidates-validators.png" alt="candidates" style="zoom:100%;"/>
