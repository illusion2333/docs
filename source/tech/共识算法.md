...
## 长安链中的共识
长安链v1.1.0起开源版本目前支持Solo，Raft，TBFT，HotStuff 四种共识类型。四种共识对比如下：
...
流程图如下：
![](../images/Consensus-Raft-interaction-Core.png)
...
![](../images/Consensus-tbft-stage.png)

流程图如下：
![](../images/Consensus-tbft-flow.png)
