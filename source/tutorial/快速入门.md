...
- 执行`build_release.sh`脚本，将编译`chainmaker-go`模块，并打包成安装包，存于路径`chainmaker-go/build/release`中
...
<a href="https://mp.weixin.qq.com/s/zGV320UDlGVVw1tTJcOsQQ" target="_blank" title="点击跳转至播放页面" >![](../images/quickstart-live.png)
...
<span id="normalError">编译chainmaker-go及chainmaker-cryptogen时可能出现的错误</span>
...
![](../images/quickstart-misssing-go.sum-entry.png)
...
![](../images/quickstart-qa-put-block.png)
